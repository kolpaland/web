...
Дизайн основан на [Material Design](https://material.io/design/introduction). Интерфейс знакомый из iOS и Android. Как сделать что-то отличное, надо поразбираться, если остановимся на этом варианте.
